...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--name', type=str, default='guitar', help='path to save results to')
        parser.add_argument('--input-pc', type=str, default='filled_pc.obj', help='input point cloud')
